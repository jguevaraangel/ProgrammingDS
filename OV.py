...
app.layout = html.Div([
    dbc.Navbar(
        dbc.Container([
            html.H2("Visual Analytics Dashboard", className="text-white mb-0 me-4", style={"fontFamily": "Playfair Display, serif"}),
            dbc.ButtonGroup([
                dbc.Button("Overview", id="btn-overview", color="primary", outline=True),
                dbc.Button("Q1", id="btn-q1", color="primary", outline=True),
                dbc.Button("Q2", id="btn-q2", color="primary", outline=True),
                dbc.Button("Q3", id="btn-q3", color="primary", outline=True),
                dbc.Button("Q4", id="btn-q4", color="primary", outline=True),
            ]),
        ]),
        color="dark",
        dark=True,
...
def createQ1Content():
    ...
    forceGraphTitle = "Q1: Director-Actor Connections"

    return dbc.Card([
        dbc.CardHeader(f"{forceGraphTitle}", className="bg-primary text-white fs-4"),
        dbc.CardBody([
            dcc.Graph(
                id=forceGraphID,
                figure={
...
def createQ2Content():
    ...
    fig.update_layout(
        ...
        showlegend=False,
        xaxis=dict(range=[0, df["AwardCount"].max() + 1]),
        yaxis=dict(range=[df["Grossing"].min() - 1, df["Grossing"].max() + 1])
    )

    return dbc.Card([
        dbc.CardHeader("Q2: Awards vs Grossing", className="bg-primary text-white fs-4"),
        dbc.CardBody([
            dcc.Graph(figure=fig)
        ])
    ], className="mb-4 shadow", style={"backgroundColor": "#1e1e1e"})
...
def createQ3Content():
    ...
    return html.Div([
        dbc.Card([ dbc.CardHeader("Directors Dashboard", 
                                  className="bg-primary text-white fs-3 text-center")], 
                 className="mb-4", style={"backgroundColor": "#1e1e1e"}),


        dbc.Card([
            dbc.CardHeader("Filter by Number of Top Directors", className="bg-primary text-white"),
            dbc.CardBody([
                dcc.Slider(
                    id='q3-top-n-slider',
                    min=dirSliderMin,
                    ...
                    step=1,
                    value=5,
                    marks={i: str(i) for i in range(dirSliderMin, dirSliderMax, math.floor((dirSliderMax-dirSliderMin)/10))},
        ...
        dbc.Card([
            dbc.CardHeader("Profitability vs Worldwide Gross per Director", className="bg-primary text-white"),
            dbc.CardBody([
        ...
        dbc.Card([
            dbc.CardHeader("Q3: Top Directors by Award Count", className="bg-success text-white"),
            dbc.CardBody([
                html.Label("Filter by Award Outcome:", className="text-white"),
                dcc.Dropdown(
        ...
        dbc.Card([
            dbc.CardHeader("Roles by Award Director Category", className="bg-warning text-dark"),
            dbc.CardBody([
                html.Label("Select Award Director Category:", className="text-white"),
                dcc.Dropdown(
        ...
        dbc.Card([
            dbc.CardHeader("IMDb Rating vs Metascore per Director", className="bg-info text-white"),
            dbc.CardBody([
...
def createQ4Content():
    ...
    return dbc.Card([
        dbc.CardHeader("Q4: Actors' Profitability", className="bg-primary text-white fs-4"),
        dbc.CardBody([
            html.Label("Select Top N Actors by Profitability:", style={"marginBottom": "10px"}),
            dcc.Slider(
                id='q4-top-n-slider',
                min=theSliderMin,
                max=theSliderMax,
                step=1,
                value=5,
                marks={i: str(i) for i in range(theSliderMin, theSliderMax, math.floor((theSliderMax-theSliderMin)/10))},
                tooltip={"placement": "bottom", "always_visible": True},
                className="mb-4"
            ),
...
def createOverview():
    return html.Div([
        ...
        dbc.Row([
            dbc.Col(
                dbc.Card([
                    dbc.CardHeader("Q3: Top Directors by Profitability (Bubble Chart)", className="bg-primary text-white fs-4"),
                    dbc.CardBody([
